...
// Can provide compile time option to do software pingpong
    ...
    volatile unsigned char hid_report_out1[HID_INT_OUT_EP1_SIZE];//YTS
    volatile unsigned char hid_report_in1[HID_INT_IN_EP1_SIZE];//YTS
    volatile unsigned char hid_report_out2[HID_INT_OUT_EP2_SIZE];//YTS
    volatile unsigned char hid_report_in2[HID_INT_IN_EP2_SIZE];//YTS
#endif
