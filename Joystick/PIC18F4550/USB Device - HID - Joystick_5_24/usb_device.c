/********************************************************************
 ...
 civil liability for the breach of the terms and conditions of thisUSB_SD_Ptr
 license.
...
ROM USB_DEVICE_DESCRIPTOR device_dsc_p0=
{
    ...
    MY_VID,                 			// Vendor ID 2 Byte
    MY_PID,                 			// Product ID: Mouse in a circle fw demo 2 Byte
...
ROM USB_DEVICE_DESCRIPTOR device_dsc_p1=
{
    ...
    USB_EP0_BUFF_SIZE,          		// Max packet size for EP0, see usb_config.h = 0x08
    MY_VID,                 			// Vendor ID 2 Byte
    MY_PID_p1,                 			// Product ID: Mouse in a circle fw demo 2 Byte
    0x0001,                 			// Device release number in BCD format
    0x01,                   			// Manufacturer string index
    0x02,                   			// Product string index
    0x00,                   			// Device serial number string index
...
ROM USB_DEVICE_DESCRIPTOR device_dsc_p2=
{
    ...
    USB_EP0_BUFF_SIZE,          		// Max packet size for EP0, see usb_config.h = 0x08
    MY_VID,                 			// Vendor ID 2 Byte
    MY_PID_p2,                 			// Product ID: Mouse in a circle fw demo 2 Byte
    0x0001,                 			// Device release number in BCD format
    0x01,                   			// Manufacturer string index
    0x02,                   			// Product string index
    0x00,                   			// Device serial number string index
...
ROM USB_DEVICE_DESCRIPTOR device_dsc_p3=
{
    ...
    USB_EP0_BUFF_SIZE,          		// Max packet size for EP0, see usb_config.h = 0x08
    MY_VID,                 			// Vendor ID 2 Byte
    MY_PID_p3,                 			// Product ID: Mouse in a circle fw demo 2 Byte
    0x0001,                 			// Device release number in BCD format
    0x01,                   			// Manufacturer string index
    0x02,                   			// Product string index
    0x00,                   			// Device serial number string index
...
ROM USB_DEVICE_DESCRIPTOR device_dsc_p4=
{
    ...
    USB_EP0_BUFF_SIZE,          		// Max packet size for EP0, see usb_config.h = 0x08
    MY_VID,                 			// Vendor ID 2 Byte
    MY_PID_p4,                 			// Product ID: Mouse in a circle fw demo 2 Byte
    0x0001,                 			// Device release number in BCD format
    0x01,                   			// Manufacturer string index
    0x02,                   			// Product string index
    0x00,                   			// Device serial number string index
...
ROM USB_DEVICE_DESCRIPTOR device_dsc_p5=
{
    ...
    USB_EP0_BUFF_SIZE,          		// Max packet size for EP0, see usb_config.h = 0x08
    MY_VID,                 			// Vendor ID 2 Byte
    MY_PID_p5,                 			// Product ID: Mouse in a circle fw demo 2 Byte
    0x0001,                 			// Device release number in BCD format
    0x01,                   			// Manufacturer string index
    0x02,                   			// Product string index
    0x00,                   			// Device serial number string index
...
ROM USB_DEVICE_DESCRIPTOR device_dsc_p6=
{
    ...
    USB_EP0_BUFF_SIZE,          		// Max packet size for EP0, see usb_config.h = 0x08
    MY_VID,                 			// Vendor ID 2 Byte
    MY_PID_p6,                 			// Product ID: Mouse in a circle fw demo 2 Byte
    0x0001,                 			// Device release number in BCD format
    0x01,                   			// Manufacturer string index
    0x02,                   			// Product string index
    0x00,                   			// Device serial number string index
...
ROM USB_DEVICE_DESCRIPTOR device_dsc_p7=
{
    ...
    USB_EP0_BUFF_SIZE,          		// Max packet size for EP0, see usb_config.h = 0x08
    MY_VID,                 			// Vendor ID 2 Byte
    MY_PID_p7,                 			// Product ID: Mouse in a circle fw demo 2 Byte
    0x0001,                 			// Device release number in BCD format
    0x01,                   			// Manufacturer string index
    0x02,                   			// Product string index
    0x00,                   			// Device serial number string index
...
ROM USB_DEVICE_DESCRIPTOR device_dsc_p8=
{
    ...
    USB_EP0_BUFF_SIZE,          		// Max packet size for EP0, see usb_config.h = 0x08
    MY_VID,                 			// Vendor ID 2 Byte
    MY_PID_p8,                 			// Product ID: Mouse in a circle fw demo 2 Byte
    0x0001,                 			// Device release number in BCD format
    0x01,                   			// Manufacturer string index
    0x02,                   			// Product string index
    0x00,                   			// Device serial number string index
...
ROM USB_DEVICE_DESCRIPTOR device_dsc_p9=
{
    ...
    USB_EP0_BUFF_SIZE,          		// Max packet size for EP0, see usb_config.h = 0x08
    MY_VID,                 			// Vendor ID 2 Byte
    MY_PID_p9,                 			// Product ID: Mouse in a circle fw demo 2 Byte
    0x0001,                 			// Device release number in BCD format
    0x01,                   			// Manufacturer string index
    0x02,                   			// Product string index
    0x00,                   			// Device serial number string index
        ...
        switch(SetupPkt.bDescriptorType)
        {
            case USB_DESCRIPTOR_DEVICE:
            {
                ...
                switch(PLAYER)
                {
                 	case 0x01:
		                {
	                    inPipes[0].pSrc.bRom = (ROM BYTE*)&device_dsc_p1;
	                    break;
	                 	}
					case 0x02:
		                {
	                    inPipes[0].pSrc.bRom = (ROM BYTE*)&device_dsc_p2;
	                    break;
	                 	}
					case 0x03:
		                {
	                    inPipes[0].pSrc.bRom = (ROM BYTE*)&device_dsc_p3;
	                    break;
	                 	}
					case 0x04:
		                {
	                    inPipes[0].pSrc.bRom = (ROM BYTE*)&device_dsc_p4;
	                    break;
	                 	}
					case 0x05:
		                {
	                    inPipes[0].pSrc.bRom = (ROM BYTE*)&device_dsc_p5;
	                    break;
	                 	}
					case 0x06:
		                {
	                    inPipes[0].pSrc.bRom = (ROM BYTE*)&device_dsc_p6;
	                    break;
	                 	}
					case 0x07:
		                {
	                    inPipes[0].pSrc.bRom = (ROM BYTE*)&device_dsc_p7;
	                    break;
	                 	}
					case 0x08:
		                {
	                    inPipes[0].pSrc.bRom = (ROM BYTE*)&device_dsc_p8;
	                    break;
	                 	}
	                 case 0x09:
		                {
	                    inPipes[0].pSrc.bRom = (ROM BYTE*)&device_dsc_p9;
	                    break;
	                 	}

	                 default:
	                 	{
		                 	inPipes[0].pSrc.bRom = (ROM BYTE*)&device_dsc_p0;
		                 	break;
		                }
		         }   
                ...
                switch(PLAYER)
                {
                 	case 0x01:
	                {                
                	inPipes[0].wCount.Val = sizeof(device_dsc_p1);  //daq
                	break;
                	}
                 	case 0x02:
	                {                
                	inPipes[0].wCount.Val = sizeof(device_dsc_p2);  //daq
                	break;
                	}  
                 	case 0x03:
	                {                
                	inPipes[0].wCount.Val = sizeof(device_dsc_p3);  //daq
                	break;
                	}  
                 	case 0x04:
	                {                
                	inPipes[0].wCount.Val = sizeof(device_dsc_p4);  //daq
                	break;
                	}  
                 	case 0x05:
	                {                
                	inPipes[0].wCount.Val = sizeof(device_dsc_p5);  //daq
                	break;
                	}  
                 	case 0x06:
	                {                
                	inPipes[0].wCount.Val = sizeof(device_dsc_p6);  //daq
                	break;
                	}  
                 	case 0x07:
	                {                
                	inPipes[0].wCount.Val = sizeof(device_dsc_p7);  //daq
                	break;
                	}  
                 	case 0x08:
	                {                
                	inPipes[0].wCount.Val = sizeof(device_dsc_p8);  //daq
                	break;
                	}  
                 	case 0x09:
	                {                
                	inPipes[0].wCount.Val = sizeof(device_dsc_p9);  //daq
                	break;
                	}  
                 	default:
	                {                
                	inPipes[0].wCount.Val = sizeof(device_dsc_p0);  //daq
                	break;
                	}                 	
                }	            	
                break;
            ...
            case USB_DESCRIPTOR_STRING:
            {
                ...
                switch(PLAYER)
                {
                 	case 0x01:
	                {  
	                	inPipes[0].pSrc.bRom = *(USB_SD_Ptr_p1+SetupPkt.bDscIndex);
	                	break;
	             	}
	             	case 0x02:
	             	{
		             	inPipes[0].pSrc.bRom = *(USB_SD_Ptr_p2+SetupPkt.bDscIndex);
		             	break;
		            } 
	             	case 0x03:
	             	{
		             	inPipes[0].pSrc.bRom = *(USB_SD_Ptr_p3+SetupPkt.bDscIndex);
		             	break;
		            } 
	             	case 0x04:
	             	{
		             	inPipes[0].pSrc.bRom = *(USB_SD_Ptr_p4+SetupPkt.bDscIndex);
		             	break;
		            } 
	             	case 0x05:
	             	{
		             	inPipes[0].pSrc.bRom = *(USB_SD_Ptr_p5+SetupPkt.bDscIndex);
		             	break;
		            } 
	             	case 0x06:
	             	{
		             	inPipes[0].pSrc.bRom = *(USB_SD_Ptr_p6+SetupPkt.bDscIndex);
		             	break;
		            } 
	             	case 0x07:
	             	{
		             	inPipes[0].pSrc.bRom = *(USB_SD_Ptr_p7+SetupPkt.bDscIndex);
		             	break;
		            } 
	             	case 0x08:
	             	{
		             	inPipes[0].pSrc.bRom = *(USB_SD_Ptr_p8+SetupPkt.bDscIndex);
		             	break;
		            } 
	             	case 0x09:
	             	{
		             	inPipes[0].pSrc.bRom = *(USB_SD_Ptr_p9+SetupPkt.bDscIndex);
		             	break;
		            } 
		            default:
	             	{
		             	inPipes[0].pSrc.bRom = *(USB_SD_Ptr_p0+SetupPkt.bDscIndex);
		             	break;
		            } 
	           	}          
