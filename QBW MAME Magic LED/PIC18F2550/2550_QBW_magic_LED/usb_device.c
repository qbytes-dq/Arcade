...
////Depricated in v2.2 - will be removed in a future revision
    ...
    extern ROM USB_DEVICE_DESCRIPTOR device_dsc_p0;
    extern ROM USB_DEVICE_DESCRIPTOR device_dsc_p1;
    extern ROM USB_DEVICE_DESCRIPTOR device_dsc_p2;
    extern ROM USB_DEVICE_DESCRIPTOR device_dsc_p3;
    extern ROM USB_DEVICE_DESCRIPTOR device_dsc_p4;
    extern ROM USB_DEVICE_DESCRIPTOR device_dsc_p5;
    extern ROM USB_DEVICE_DESCRIPTOR device_dsc_p6;
    extern ROM USB_DEVICE_DESCRIPTOR device_dsc_p7;
    extern ROM USB_DEVICE_DESCRIPTOR device_dsc_p8;
    extern ROM USB_DEVICE_DESCRIPTOR device_dsc_p9;
#else
...
extern ROM BYTE *ROM USB_SD_Ptr_p0[];
extern ROM BYTE *ROM USB_SD_Ptr_p1[];
extern ROM BYTE *ROM USB_SD_Ptr_p2[];
extern ROM BYTE *ROM USB_SD_Ptr_p3[];
extern ROM BYTE *ROM USB_SD_Ptr_p4[];
extern ROM BYTE *ROM USB_SD_Ptr_p5[];
extern ROM BYTE *ROM USB_SD_Ptr_p6[];
extern ROM BYTE *ROM USB_SD_Ptr_p7[];
extern ROM BYTE *ROM USB_SD_Ptr_p8[];
extern ROM BYTE *ROM USB_SD_Ptr_p9[];
